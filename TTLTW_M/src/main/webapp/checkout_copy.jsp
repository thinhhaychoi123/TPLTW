                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="py-4">${cartview.productPrice}</td>
                                        <td class="py-4 text-center">${cartview.quantity}</td>
                                        <td class="py-4">${cartview.totalPrice}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-4"></td>
                                        <td class="py-4">
                                            <p class="mb-0 text-dark py-2">Tổng</p>
                                        </td>
                                        <td class="py-4">
