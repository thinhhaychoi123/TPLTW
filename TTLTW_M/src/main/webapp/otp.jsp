	...
	<div class="auth-wrap">
		<div class="auth-card">
			...
			<div class="auth-header">
				...
				<p class="auth-sub">Vui lòng nhập mã xác nhận đã gửi lên
			...
			<div class="auth-body">
				...
				<form class="form" method="post"
					...
					<div class="field">
						<label>Mã xác nhận</label> <input class="input" type="text"
							name="otp" placeholder="Mã OTP"
				...
				Nhập tài khoản khác? <a class="link"
					href="${pageContext.request.contextPath}/register">Đăng nhập</a>
				</div>
				<div class="auth-footer">
